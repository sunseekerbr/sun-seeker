  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6"
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-sm mt-2" style={{ color: '#666' }}>A comunidade dos caçadores de pôr do sol</p>
      </div>
      ...
      <div className="w-full max-w-sm flex flex-col gap-4">
        ...
        <button onClick={handleGoogle} className="btn-secondary flex items-center justify-center gap-2">
